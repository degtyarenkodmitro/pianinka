...
class Slider:
    def __init__(self, x, y, width, min_val, max_val, step=1, initial=None, label="", value_to_text=""):
    ...
    def draw(self, screen, font=None):
        pygame.draw.rect(screen, (0, 0, 0), self.track_rect, border_radius=3)
        pygame.draw.rect(screen, (0, 255, 0), self._hit_rect, 1, border_radius=3)
        ...
        if font and self.label:
            ...
            screen.blit(text, (self.track_rect.left, self.track_rect.top + 10))
